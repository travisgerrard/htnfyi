  ...
  return (
    <Container>
      <NameContainer>
        ...
        <BottomContainer>
          <Link href="/medications/metformin">Weight Loss</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/sulfonylureas">DASH Diet</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/dpp4-inhibitors">Sodium (Salt)</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/sglt2-inhibitors">Potassium</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/glp1-agonists">Aerobic Exercise</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/insulin">Resistance Exercise</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/insulin">Isometric Exercise</Link>
        </BottomContainer>
        <BottomContainer>
          <Link href="/medications/insulin">Alcohol Reduction</Link>
        </BottomContainer>
      </NameContainer>
